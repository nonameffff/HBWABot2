...
case 'dare':
    ...
    "say i love the bot owner HBmods through voice note",
    ...
    "do you love the bot creator, HBmods?ðŸ¦„",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Join WhatsApp Bot Group",
body: "Click to join Group", 
...
break
case 'ytpro': case 'utubepro': case 'youtubepro': {
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
teks = `*「YouTube Pro Last Version」*/\nhttps://herbert70.blogspot.com/2022/07/youtube-pro.html\n\nYouTube: ${global.websitex}\nGitHub: ${global.botscript}\n\nDont forget to subscribe`
let buttons = [
{buttonId: `hbmods`, buttonText: {displayText: '❤️'}, type: 1}
]
let buttonMessage = {
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 HBMods Menu 」	
╠🔥${prefix}gbwhatsapp / gb
╠🔥${prefix}instagrampro / igpro
╠🔥${prefix}youtubepro / ytpro
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "𝗬𝗼𝘂𝗧𝘂𝗯𝗲","url": `${websitex}`}},{"urlButton": {"displayText": "𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
